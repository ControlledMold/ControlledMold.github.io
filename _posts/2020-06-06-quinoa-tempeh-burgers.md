...
1. Add a generous amount of oil to a pan, and turn to medium-high pan. Once near smoking point, add patties. Flip once underside is starting to brown, and apply yeast garum mixture to the top. Flip, and repeat. Let the patties darken more, but careful not to burn.
